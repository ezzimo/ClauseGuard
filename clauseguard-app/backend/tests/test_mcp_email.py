...
def test_envoyer_email_juriste_with_valid_pdf_url(monkeypatch):
    ...
    res = mcp_server.envoyer_email_juriste(
        contract_id="c12345678",
        overall_risk="FAIBLE",
        resume="Resume test",
        request_id="req1",
        pdf_url="http://127.0.0.1:8000/api/contracts/c12345678/report/pdf/internal",
        pdf_filename="ClauseGuard_c1234567.pdf",
    )
    ...
    assert "ClauseGuard_c1234567.pdf" in msg_str
